class Word < ActiveRecord::Base
	...
	def self.get_words(query_string,query_length,query_method)
		...
		sorted_seq = get_substrings(query_string, query_string.length)
